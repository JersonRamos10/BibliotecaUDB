...
public interface BibliotecaService {
    ...
    Prestamo obtenerDetallesPrestamoParaDevolucion(int idPrestamo) throws SQLException, BibliotecaException;
    boolean actualizarDatosDocumento(Documento documento) throws SQLException, BibliotecaException;
    PoliticasPrestamo obtenerPoliticaPorTipoUsuario(int idTipoUsuario) throws SQLException, BibliotecaException;
}